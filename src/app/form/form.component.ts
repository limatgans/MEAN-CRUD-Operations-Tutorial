...
import { MatDatepickerInput, MatDatepicker } from '@angular/material';
...
export class FormComponent implements OnInit {
  ...
  validate() {
    ...
    alert('!compare_dates' + !compare_dates);
  ...
  addEmployee() {
    this.employeeservice.addEmployee(this.firstname,
                                     this.lastname,
                                     this.mobile,
                                     this.email,
  ...
  validateEmail() {
    ...
    this.employeeservice.validateEmail(this.email)
                        .subscribe(val => {
                            ...
                            if (flag) {
                              alert('Email already exists, enter new mail');
                              this.refresh();
                              return;
                            }
                            if (emailFlag === false) {
